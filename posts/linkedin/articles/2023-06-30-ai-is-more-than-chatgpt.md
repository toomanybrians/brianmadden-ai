---
title: "AI is more than ChatGPT"
date: "2023-06-30"
authority_level: 5
file_type: linkedin-article
tags: [ai-taxonomy, chatgpt, llm, machine-learning, generative-ai]
related_frameworks: []
...
*Published: https://www.linkedin.com/pulse/ai-more-than-chatgpt-brian-madden/*
...
After a few months of playing with it, I started talking about how "AI is going to change X" or "AI is going to be huge for Y," etc. I'm not alone there either, as everyone who experiences ChatGPT starts to form opinions about what AI can or cannot do, or how AI will or will not change the world.

But forming opinions on "AI" based on our experience with ChatGPT is dangerous, because: ChatGPT is not the same as "AI". Rather, ChatGPT is one specific implementation of one specific type of AI. But the overall AI universe is much, much bigger.

To understand the relationship of "ChatGPT" to "AI", here's the path starting from the highest level universe of AI, drilling down through the layers to ChatGPT:

- **Artificial Intelligence (AI)** is an academic discipline which involves machines mimicking cognitive functions.
- **Machine Learning (ML)** is a subset of AI where systems learn patterns from data.
- **Generative Models** are a type of ML that generate new outputs from given inputs.
- **Large Language Models (LLM)** are a type of generative model specifically designed for text data.
- **Autoregressive Models** are a type of LLM that generate sequences (e.g. words and sentences) one element at a time.
...
- **ChatGPT** is a specific application of a GPT which interacts with users in a conversational way.

In other words, from broad to narrow: AI → ML → Generative Models → LLMs → Autoregressive Models → GPTs → ChatGPT

*Image: Concentric circles diagram showing the lineage of AI to GPT technologies & concepts, from broadest (AI) to narrowest (ChatGPT). Circles not to scale—just showing how the various technologies relate to each other.*
...
*Image: Zoomed-in diagram of the AI family tree showing several of OpenAI's GPT models (gpt-3.5-turbo, gpt-4, etc.) as well as other generative models at higher layers.*
...
*Image: Chart showing Language Model Sizes, created by Dr. Alan D. Thompson, LifeArchitect.ai—comparing relative sizes of different LLMs.*
...
- Every AI "layer" covered here is also much bigger and includes more than we covered in the drill-down to ChatGPT.
...
*This text is AI Influence Level 1: Human conceived & created. Minor AI assistance. (AI used to fact check.)*

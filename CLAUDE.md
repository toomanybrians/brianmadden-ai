...
Note: This file is identical to `AGENTS.md`. Both exist so that any AI tool finds instructions regardless of which filename convention it uses.
...
3. **`me/published-thinking.md`** — intellectual foundation derived from published work (38 Citrix blog posts, Apr 2025–Sep 2026 + 21 LinkedIn articles, Jun 2020–Feb 2026)
...
- **`frameworks/`** — standalone explainers for each of Brian's 10 active frameworks (80/20, knowledge factory, post-application era, workspace-as-control-plane, cognitive stack, etc.). Load the relevant framework file when a specific framework comes up. Two retired frameworks live here too, marked `status: archived` in their frontmatter — kept for lineage, not for loading.
...
├── frameworks/        # Standalone framework explainers (10 active, 2 archived)
│   ├── 7-stage-roadmap.md
│   ├── 2031-worker-shape.md
│   ├── bitter-lesson.md
│   ├── cognitive-stack.md
│   ├── delegation-not-automation.md  # archived — see file
...
│   ├── citrix-blog/   # Citrix blog posts (38 posts, Apr 2025–September 2026)

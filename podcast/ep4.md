---
title: "EP 4: OSWorld 2.0, AI Reconciliation Maps, & the Futurist's Playbook"
date: "2026-07-15"
...
*Citrix AI Hotsheet · Brian Madden & Dave Brear · July 15, 2026*

## Listen

- **Show home:** https://citrixaihotsheet.riverside.com/e/osworld-2-0-ai-reconciliation-maps-the-futurist-s-playbook
...
- **YouTube:** https://www.youtube.com/watch?v=iRokb-q-gsA
...
- OSWorld 1.0 is saturated: even Sonnet-class models beat the median human
- OSWorld 2.0: ~100 domain-expert tasks averaging 90 minutes of real knowledge work
- Cost as a first-class benchmark metric: which AI at what effort level for what price
- "Humans are cheaper" — when the AI runs $2,000 a day in tokens
- Two kinds of hallucination: thin context vs. contradictory sources
- Poisoning enterprise context by sending an email
- The reconciliation map: a new step for enterprise second-brain workflows
- Whether the reconciliation map generalizes from one worker to the whole enterprise
- Why every consulting firm's org-AI-maturity ladder is the wrong shape
- The treehouse: many branches, no single destination, maturity is your approach to change
- Why the futurist's job is mapping scenarios, not predicting one
- The four axes of AI uncertainty: acceleration, diffusion, bubble, geopolitics
- Forward-deployed engineers as a diffusion accelerant
- What survives every scenario: Sonnet-class open-weight models, on hardware you own
- The takeaway: do the second-brain and knowledge-factory work today — it pays off no matter what

## Chapters

*(Timestamps are estimates from the transcript — verify against Riverside before final upload.)*

- 0:00 — Welcome (and a note on France last night)
- 1:06 — Four topics for July
- 1:35 — OSWorld 1: AI beat the humans, benchmark saturated
- 3:29 — OSWorld 2.0: 90-minute tasks, cost as a metric, current leaderboard
- 10:25 — "Humans are cheaper" and the consulting angle
- 11:30 — Context, taste, and how you talk into AI (Dave)
- 13:13 — The filing cabinet and cork board analogy
- 14:46 — Two ways hallucination still creeps in
- 18:01 — Poisoning context via email
- 18:36 — Adding a reconciliation stage to the workflow
- 23:04 — Naming it: the reconciliation map
- 23:14 — Does the reconciliation map scale across the enterprise?
- 27:06 — Audible: rolling the org-maturity topic in early
- 27:30 — Every consulting firm already built a ladder
- 32:32 — Why treehouse beats ladder
- 33:04 — Maturity is your approach to change, not your tools
- 36:00 — Being a futurist: not predicting, mapping scenarios
- 39:04 — Wild card: which data sources you trust
- 42:00 — The four axes: acceleration, diffusion, bubble, geopolitics
- 42:30 — What "diffusion" means
- 44:00 — Forward-deployed engineers close the gap faster
- 46:00 — What if the AI bubble pops?
- 50:54 — What we know for sure will exist
- 52:58 — Second brain on your phone
- 53:54 — The takeaway: do the work now
- 55:49 — Wrap (and Go England)

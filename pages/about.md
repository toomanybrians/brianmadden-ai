---
title: "About brianmadden.ai"
authority_level: 3
file_type: page
tags: ["identity", "second-brain", "substack", "faq"]
...
**Is this a chatbot?**
No. It's a knowledge source your AI connects to. You talk to your own AI; it draws on this when relevant.

**Is this a digital twin?**
No. A digital twin simulates a person. This makes published thinking accessible — a living reference library, not a simulation of me.

**How current is it?**
The pipeline runs daily. My "current thinking" file updates frequently and is explicitly separated from settled, published positions — the system flags what's still developing rather than presenting it as final.

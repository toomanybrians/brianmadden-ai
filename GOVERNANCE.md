...
This document governs what goes into brianmadden.ai and what stays out. It applies to every commit and every piece of content added to this repo.
...
1. **Grounded in the public record.** Every piece of content in this repo should already be published, or be a direct synthesis of published material — a Citrix blog post, a LinkedIn article, a conference talk, a press interview, a podcast appearance. If I haven't said it somewhere public, it doesn't appear here as if I had. This repo doesn't originate positions in private and publish them later; it's built from, and stays anchored to, what's already on the record.
...
4. **Clean fossil record.** Git history is permanent. Every commit message, every intermediate version, every file that was added and later deleted—all of it persists in the repo history. Content must be right before it's committed, not fixed after.

5. **My voice, not corporate messaging.** This repo represents Brian Madden's perspective as an independent thinker who works at Citrix. The value comes from authenticity, not from alignment with marketing messaging. That said, nothing here should contradict or undermine Citrix's interests.
...
If any other process or tool used to prepare content for this repo conflicts with this document, this document wins.
